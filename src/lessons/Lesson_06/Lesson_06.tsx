function Lesson_06() {
  ...
  let hello = `Hello. ${userFullName}`; //  если мы явно не прописываем тип переменной, то тип 
  // назначается автоматически, в зависимости от того, какое значение переданно изначально для переменной
