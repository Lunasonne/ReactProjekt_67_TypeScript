...
function Lesson_10() {
  ...
  const getCatFact = async () => {
    try {
      ...
      // Выпонляем код, когда нам пришла ошибка, т.е когда Promise Result === rejected
  ...
  // // UNMOUNTING
  // useEffect(() => { return () => {console.log("UMOUNTING!!!")} } , [])
...
// Когда isLoading = true кнопка становится неактивной.
